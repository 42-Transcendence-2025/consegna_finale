...
from .views import PongLoginView, PongRegisterView, PongUserView, VerifyOTPView, PongProfileView, PongUserListView, PongRefreshTokenView, PongLogoutView, ProfileImageUploadView, PongFriendView
